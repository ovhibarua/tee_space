...
import pay from "../assets/img/footer-payment-method.png.png";
import { motion } from "motion/react";
import Button from "./Button";
import Input from "./Input";
const footerContent = [
  ["About us", "Our Blog", "Start a Return", "Contact Us", "Shipping FAQ"],
  [
    "Printing Services",
    "Digital Scanning",
    "Design Services",
    ...
    <footer className="container mx-auto py-20">
      <div className="flex justify-between mb-20">
        <div>
          ...
          <p className="font-bold text-black mb-3">+02 036 038 3996</p>
          <p>
